...
void main(void) {
   vec3 lightPosition, lightDirection, lightColor, lightAttr, texColor, normal, reflection, view, ambient, diffuse, specular, rColor;
   ...
   for (int i = 0; i < 3; i++) {
	   ...
	   illumination = lightStrength / (1.0 + 2.0*lightDistance + 0.2 * lightDistance*lightDistance);
